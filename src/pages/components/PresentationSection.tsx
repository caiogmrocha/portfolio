...
export function PresentationSection(props: PresentationSectionProps) {
    return (
        <section {...props}>
            ...
            <h1 className="text-2xl text-zinc-900 font-bold mt-2">
                Caio Rocha
            </h1>
            <h2 className="text-xl font-bold bg-gradient-to-r from-indigo-500 vi-blue-600 to-cyan-400 text-transparent bg-clip-text inline-block mt-1">
                Software Developer
            </h2>
        </section>
    );
